...
class _CalendarState extends State<Calendar> {
  ...
  Widget get nameAndIconRow {
    ...
    if (!widget.hideArrows) {
      ...
      leftArrow = rightArrow = const SizedBox();
    }
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          //   widget.eventListBuilder!(context, _selectedEvents!)
        ],
      ),
    );
  }
  ...
  void nextMonth() {
    setState(() {
      ...
      final DateTime firstDateOfNewMonth = Utils.firstDayOfMonth(_selectedDate);
      final DateTime lastDateOfNewMonth = Utils.lastDayOfMonth(_selectedDate);
  ...
  void handleSelectedDateAndUserCallback(DateTime day) {
    DateTime firstDayOfCurrentWeek = _firstDayOfWeek(day);
    DateTime lastDayOfCurrentWeek = _lastDayOfWeek(day);
  ...
  List<DateTime> _daysInMonth(DateTime month) {
    DateTime first = Utils.firstDayOfMonth(month);
    int daysBefore = first.weekday;
    DateTime firstToDisplay =
        first.subtract(new Duration(days: daysBefore - 1));
    DateTime last = Utils.lastDayOfMonth(month);
    ...
    final DateTime lastToDisplay = last.add(Duration(days: daysAfter + 1));
